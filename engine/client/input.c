...
void IN_StartupMouse( void )
{
	...
	fake_m_ignore = Cvar_Get( "m_ignore", "1", CVAR_ARCHIVE , "ignore mouse events" );
	m_ignore = Cvar_Get( "m_ignore_f", DEFAULT_M_IGNORE, CVAR_ARCHIVE , "ignore mouse events" );
