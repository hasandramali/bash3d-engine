...
void Touch_Init( void )
{
	...
	// input devices cvar
	fake_touch_enable = Cvar_Get( "touch_enable", "1", CVAR_ARCHIVE, "enable touch controls" );
	touch_enable = Cvar_Get( "touch_enable_f", DEFAULT_TOUCH_ENABLE, CVAR_ARCHIVE, "enable touch controls" );
