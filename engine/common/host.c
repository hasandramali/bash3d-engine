...
int EXPORT Host_Main( int argc, const char **argv, const char *progname, int bChangeGame, pfnChangeGame func )
{
	...
	ver = Cvar_Get( "ver", "ver: 48/0.98.3366", CVAR_INIT, "shows an engine version. left for compatibility" );
	host_build = Cvar_Get( "host_build", "1200", CVAR_INIT, "returns current build number" );
	host_ver = Cvar_Get( "host_ver", "host_ver: 1200 0.19.2 Android arm release", CVAR_INIT, "detailed info about this build" );
